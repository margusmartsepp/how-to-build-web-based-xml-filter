...
public class PXML {
	...
	public static class XSLT {
		 ...
		 * @param sw
		 *        the sw
		 * @return the writer * @throws TransformerException the transformer
		 *         exception * @see PXML * @see XSLT
		 */
		 ...
		 *         the transformer exception * @throws IOException * @see PXML * @see
		 *         XSLT
		 */
	...
	public static Report filter5(HumanResources hm) {
		...
		for (Employee em : hm.getEmployee()) {
