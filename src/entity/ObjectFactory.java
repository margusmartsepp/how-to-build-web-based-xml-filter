 ...
 * element interface generated in the entity package.
 * <p>
...
@XmlRegistry public class ObjectFactory {
	...
	private final static QName _HumanResources_QNAME = new QName("",
			"humanResources");
	...
	private final static QName _CompensationDateSpan_QNAME = new QName("",
			"compensationDateSpan");
	 ...
	 * schema derived classes for package: entity.
	 */
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link HumanResources }
	 * {@code >} .
	 * 
	 * @param value
	 *        the value
	...
	@XmlElementDecl(namespace = "", name = "humanResources") public JAXBElement<HumanResources> createHumanResources(
		...
		return new JAXBElement<HumanResources>(_HumanResources_QNAME,
				HumanResources.class, null, value);
	}
	 ...
	 * {@link CompensationDateSpan }{@code >} .
	 * 
	 * @param value
	 *        the value
	...
	@XmlElementDecl(namespace = "", name = "compensationDateSpan") public JAXBElement<CompensationDateSpan> createCompensationDateSpan(
		...
		return new JAXBElement<CompensationDateSpan>(_CompensationDateSpan_QNAME,
				CompensationDateSpan.class, null, value);
	}
